...
class AnimationThread(threading.Thread):
    ...
    def run(self):
        ...
        os.system('ffmpeg -i animation.mp4 -i ' + self.audio_intro_abs + ' -c:v copy -c:a aac -strict experimental animation_with_audio.mp4 -y')
        ...
        os.system('start animation_with_audio.mp4')
