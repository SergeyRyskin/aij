...
def main():
    ...
    tech_news = """
    Last week, the US government announced that it would ban the use of TikTok and WeChat in the country.
    ...
    animation.generate_animation(num_frames, random.choice(tech_news.split('\n')))
